...
from BibNet_train import MultiModalNet, FCViewer
...
def draw(y_true,y_pred,labels):
    ...
    plot_confusion_matrix(cm_normalized, labels, title='Confusion matrix using remote sensing images')
    # show confusion matrix
    plt.savefig('Confusion_Bib-DNN-2.png', format='png')
    plt.close()
...
def main(args):
    ...
    # model2 = torch.load('.\\model-UFZ\\RSIMG-UFZ-teacher-resnext50_32x4d_4class.pth')
